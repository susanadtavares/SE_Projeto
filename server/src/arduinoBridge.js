...
// Tenta pegar a porta serial dos argumentos (ex: node src/arduinoBridge.js COM3)
const portPath = process.argv[2];

if (!portPath) {
  console.log('Por favor, especifique a porta serial.');
  console.log('Exemplo: node src/arduinoBridge.js COM3 (Windows) ou /dev/ttyUSB0 (Linux/Mac)');
